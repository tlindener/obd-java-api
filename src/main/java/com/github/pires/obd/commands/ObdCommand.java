...
public abstract class ObdCommand {
	 ...
	 */
	private final Class[] ERROR_CLASSES = { UnableToConnectException.class, BusInitException.class,
	...
	protected void fillBuffer() {
		...
		String rwSubString = rawData.substring(0, 4);
		System.out.println(rwSubString);
		String cmdRepl = cmd.replace(" ", "");
		System.out.println(cmdRepl);
		if (rawData.length() > 1) {
			if (rwSubString.equalsIgnoreCase(cmdRepl)) {
	...
	protected void readRawData(InputStream in) throws IOException {
		 ...
		 */
		System.err.println("ObdCommand: " + res.toString());
